...
# get exported shares / directories via showmount
# TOOLS: showmount
do_showmount()
{
    opts="-e"

    showmount ${opts} ${DHOST} 2>&1

    return ${SUCCESS}
}


# get infos about clients connected to mounted dirs via showmount
# TOOLS: showmount
do_showmount_clients()
{
    opts="-a"

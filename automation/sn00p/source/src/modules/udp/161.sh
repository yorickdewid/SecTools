...
# get infos over version 1 via snmpwalk
# TOOLS: snmpwalk
do_snmpwalk_v1()
{
    opts="-v 1 -c public"

    snmpwalk ${opts} ${DHOST} 2>&1

    return ${SUCCESS}
}


# get infos over version 2 via snmpwalk
# TOOLS: snmpwalk
do_snmpwalk_v2()
{
    opts="-c public -v 2c"
...
# get infos via onesixtyone
# TOOLS: onesixtyone
do_onesixtyone()
{
    opts="-d"

    onesixtyone ${opts} ${DHOST} "public" 2>&1

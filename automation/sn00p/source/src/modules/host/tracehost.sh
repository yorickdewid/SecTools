...
# trace the route to target using traceroute
# TOOLS: traceroute
do_traceroute()
{
    opts="-q 2 -w 3 -4"

    traceroute ${opts} ${DHOST} 2>&1

    return ${SUCCESS}
}


# trace the route to target using tcptraceroute
# TOOLS: tcptraceroute
do_tcptraceroute()
{
    opts="-q 2 -w 1"

    tcptraceroute ${DHOST} ${DPORT} 2>&1

    return ${SUCCESS}
}


# trace the route to target using tracepath
# TOOLS: tracepath
do_tracepath()
{
    tracepath -n ${DHOST} 2>&1

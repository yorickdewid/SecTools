...
# scan for xss vulnerabilities with uwss
# TOOLS: uwss.sh
do_uwss_xss()
{
    opts="-m xss -q"
...
# scan for xss vulns with xsser
# TOOLS: xsser
do_xsser()
{
    opts="--Cw=5 --Onm --Ifr --B64 --Coo --Xsa --Xsr --Dcp --Dom --Ind --Anchor"
    opts="${opts} --Phpids --auto --follow-redirects"

    xsser ${opts} -u ${URL} 2>&1

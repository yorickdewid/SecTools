...
# try to get version of identd via netcat
# TOOLS: nc
do_ident_version()
{
    echo "version" | nc -vv -w 3 ${DHOST} ${DPORT} 2>&1

    return ${SUCCESS}
}


# try to get onwer of running proccess via nmap ident scan
# TOOLS: nmap
do_ident_scan()
{
    opts="-n -I -PN"

...
# get remote rpc services via rpcinfo
# TOOLS: rpcinfo
do_rpcinfo()
{
    opts="-p"

    rpcinfo ${opts} ${DHOST} 2>&1

    return ${SUCCESS}
}


# get logged in users over rusersd via rusers
# TOOLS: rusers
do_rusers()
{
    opts="-l"

    rusers ${opts} ${DHOST} 2>&1
